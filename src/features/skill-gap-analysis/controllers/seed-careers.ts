...
async function seed() {
    ...
    const skills = [
        ...
        "PostgreSQL", "MySQL", "SQLite", "HTML", "CSS",
        "Tailwind CSS", "Git", "GitHub", "Docker", "Kubernetes",
        ...
        "Cryptography", "OWASP", "Wireshark",
        "REST API", "GraphQL", "Microservices",
        "System Design", "Android", "Kotlin",
        "Flutter", "React Native",
        "Unity", "Unreal Engine",
        "Blockchain", "Solidity", "Smart Contracts",
        "IoT", "Embedded C", "Arduino",
        "Raspberry Pi", "Testing", "JUnit",
        "Selenium", "CI/CD", "Terraform"
    ];
    ...
    console.log("All careers and skills seeded successfully");
}
