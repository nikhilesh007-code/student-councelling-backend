...
const PREDEFINED_RELATIONSHIPS: Record<string, string[]> = {
    'javascript': ['typescript', 'frontend development', 'web development', 'node.js', 'react', 'vue', 'angular'],
    'typescript': ['javascript', 'frontend development', 'web development', 'node.js', 'angular', 'react'],
    'react': ['frontend development', 'web development', 'javascript', 'typescript', 'next.js', 'react native'],
    'reactjs': ['react', 'frontend development', 'web development', 'javascript', 'typescript', 'next.js', 'react native'],
    'node.js': ['express', 'backend development', 'javascript', 'typescript', 'web development'],
    'nodejs': ['node.js', 'express', 'backend development', 'javascript', 'typescript', 'web development'],
    'express': ['node.js', 'backend development', 'javascript', 'typescript', 'web development', 'express.js'],
    ...
    'python': ['machine learning', 'data science', 'backend development', 'data analysis', 'artificial intelligence', 'ai', 'deep learning', 'pandas', 'numpy', 'tensorflow', 'pytorch'],
    'machine learning': ['python', 'data science', 'artificial intelligence', 'ai', 'deep learning', 'statistics', 'tensorflow', 'pytorch'],
    ...
    'data structures': ['algorithms', 'problem solving', 'competitive programming', 'computer science fundamentals'],
    'algorithms': ['data structures', 'problem solving', 'competitive programming', 'computer science fundamentals'],
    'java': ['spring boot', 'backend development', 'object oriented programming', 'oop'],
    'c++': ['c', 'object oriented programming', 'oop', 'competitive programming', 'systems programming'],
    'c#': ['.net', 'backend development', 'object oriented programming', 'oop'],
    'html': ['css', 'frontend development', 'web development', 'web design'],
    'css': ['html', 'frontend development', 'web development', 'web design', 'tailwind css', 'bootstrap'],
...
export async function matchSkills(requiredSkills: string[], userSkills: string[]): Promise<SkillMatchDetails[]> {
    ...
    for (const reqSkill of requiredSkills) {
        ...
        if (normalizedUserSkillsRaw.includes(normReqRaw) || normalizedUserSkills.includes(normReq)) {
            const index = normalizedUserSkillsRaw.indexOf(normReqRaw) !== -1 
        ...
        for (let i = 0; i < userSkills.length; i++) {
            ...
            const relatedReq = PREDEFINED_RELATIONSHIPS[normReqRaw] || PREDEFINED_RELATIONSHIPS[normReq] || [];
            const relatedUser = PREDEFINED_RELATIONSHIPS[normUserRaw] || PREDEFINED_RELATIONSHIPS[normUser] || [];

            if (relatedReq.some(r => r === normUserRaw || normalizeSkill(r) === normUser) || 
