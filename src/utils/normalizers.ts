export class SkillNormalizer {
	static normalize(skill: string): string {
		...
		if (lower === 'node' || lower === 'nodejs' || lower === 'node js' || lower === 'node.js') return 'Node.js';
...
export class CareerNormalizer {
	static normalize(career: string): string {
		...
		if (lower === 'frontend' || lower === 'frontend developer' || lower === 'front-end developer') return 'Frontend Developer';
		if (lower === 'backend' || lower === 'backend developer' || lower === 'back-end developer') return 'Backend Developer';
		if (lower === 'software engineer' || lower === 'swe') return 'Software Engineer';
		if (lower === 'ai engineer' || lower === 'ai/ml engineer' || lower === 'machine learning engineer') return 'AI/ML Engineer';
